...
$(function() {
  ...
  $("#user-email").inputmask("email");
  $(".order-btn").click(function() { 
    $('html, body').animate({
        scrollTop: $(".registration").offset().top + 70
    }, 1000); 
  });
  let mainSlider = $('.slider-app');
  mainSlider.slick({
  ...
  $('.slick-slide').click(function() {
    let currentIndex = mainSlider.slick('slickCurrentSlide');
 ...
 $(function() {
    $("#user-form").validate({
      ...
      messages: {
        firstname: "Пожалуйста выбирите город",
...
var scrollme = ( function( $ )
{
	...
	_this.animate = function()
	{
        ...
        // $(_this.scrollme_selector).prev().css(
        //   'margin-bottom', effect.element[0].getBoundingClientRect().height - effect.element.innerHeight()
        // )
			}
		}
	}
    ...
    for (var i = 0, l = sticked.length; i < l; i++) {
      ...
      if (scrollTop <= etse) {
        if (s.currentTop !== null) {
          ...
          s.stickyElement.parent().css('width', 'auto');
        ...
        if (s.currentTop !== newTop) {
          ...
          s.stickyElement.parent().css('width', s.stickyElement.outerWidth())
